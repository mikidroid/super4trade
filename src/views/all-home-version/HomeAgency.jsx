                    ...
                    >
                      ...
                      <div className="ptf-phone-block">
                        ...
                        <div className="ptf-phone-block__phone">
                          <a style={{fontSize:20}} href="tel:+2348036916313,  ">(+234) 08036916313</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-lg-5 offset-lg-7">
                    ...
                    >
                     ...
                     <A.TY1>
                      ...
                      ></div>
                      <p className="fz-18" data-aos="fade-up" style={{ maxWidth: "30rem" }}>
                       
MAFA Group is a value driven organization, we play a significant role in 
the value chain of the economy. We have developed winning business 
strategies, provided standard goods and services, and recognized the 
impact on our clients/customers to boost their businesses and give them 
value for every penny spent on all our products and services within our 
scope. This is done within the framework of professionalism and 
flexibility. 
                      </p>
                      <p data-aos="fade-up" className="fz-18 mb-3" style={{ maxWidth: "30rem" }}>
  The Group is organized into tiers of subsidiary companies and our wealth 
of knowledge, new ideas, technical expertise, and innovativeness, 
overtime has built subsidiaries in their different respective sectors from 
rice milling, integrated farming, security, and consulting.        
</p>
<p className="fz-18 mb-3 fw-600 has-accent-1">
<Link to="/about-us"> Read more.. </Link>
            ...
            {/*=============================================
          Start Service section with jarallax
          ============================================== */}
            ...
            <section  className="jarallax jarallax-img"
              ...
              <div className="container">
                ...
                <div
                  ...
                  data-aos-delay="0"
                >
                  <h2 className="h1 large-heading text-white">Our Group</h2>
                </div>
                {/* <!--Spacer--> */}
                <div
                  className="ptf-spacer"
                ...
                >
                  ...
                  <div className="col-12 col-md-6">
                    ...
                    >
                      ...
                      {/* <!--Services List--> */}
                      {/*<ListTwo />*/}
                       <p className="fz-18 text-white" style={{ maxWidth: "30rem" }}>

At Mafa Group, we are responsible in everything we do, we are guided by our purpose, 
and we aim to create fair and sustainable value in everything we undertake as a group. 
Within our Strength we thrust forward the agenda of opportunity, sufficiency & 
security in the country.</p>
<p className="fz-18 text-white" style={{ maxWidth: "30rem" }}>
Through our Outreach programme we advocate and 
contribute our support for rice farmers, for quality and sustainable livelihood, which 
will in turn zero down the level of poverty in Nigeria, under our Social development 
programme. Our impact is felt all over Nigeria. 
</p>

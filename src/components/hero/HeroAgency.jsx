      ...
      <Slider {...settings}>
          ...
          <div className="ptf-showcase-slide">
            <div className="container">
              ...
              <h1  className="fz-100 fz-90--lg lh-1 has-white-color text-center">
                <span data-aos="fade-up" data-aos-duration="1000" className="has-accent-1">Quality</span><br/>With
                Integrity 
              </h1>
        ...
        <div className="ptf-showcase-image image-2" >
          <div className="ptf-showcase-slide">
            <div className="container">
              <h1 className="fz-100 fz-90--lg lh-1 has-white-color text-center">
                <span className="has-accent-1">Unique</span> Technical <br />
                Expertise
              </h1>
              {/* <!--Spacer--> */}
              <div
          ...
          <div className="ptf-showcase-slide">
            <div className="container">
              <h1 className="fz-100 fz-90--lg lh-1 has-white-color">
                <span className="has-accent-1">Crafting</span> Innovative
                Experience
              </h1>
              {/* <!--Spacer--> */}
              <div

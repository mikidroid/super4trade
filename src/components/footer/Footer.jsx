    ...
    <div className="row">
      <div className="col-12 col-xl-6">
        ...
        <div className="ptf-animated-block" data-aos="fade" data-aos-delay="0">
          ...
          <p className="fz-24">km 11 Hadejia Road Gunduwawa Industrial Estate  
Gezawa Local Government, Kano, Nigeria. 
 </p>
          <a className="fz-30 has-black-color" href="mailto:admin@mafagroup.com">
            admin@mafagroup.com
          </a>
        </div>
      </div>
